...
def market_bargainingchip():
    ...
    button_1.click()
    time.sleep(2)
    button_2 = driver.find_element_by_link_text("5")
    button_2.click()
    time.sleep(2)
    ...
    button7.click()
    time.sleep(2)
    button8 = driver.find_element_by_link_text("6")
    button8.click()
    time.sleep(2)
    ...
    button10.click()
    time.sleep(2)
    button11 = driver.find_element_by_link_text("6")
    button11.click()
    time.sleep(2)
    ...
    button13.click()
    time.sleep(2)
    button14 = driver.find_element_by_link_text("5")
    button14.click()
    time.sleep(2)
    ...
    button16.click()
    time.sleep(2)
    button17 = driver.find_element_by_link_text("6")
    button17.click()
    time.sleep(2)
