...
def market_bargainingchip():
    ...
    button1.click()
    time.sleep(2)
    button2 = driver.find_element_by_link_text("23")
    button2.click()
    time.sleep(2)
    ...
    button_1.click()
    time.sleep(2)
    button_2 = driver.find_element_by_link_text("22")
    button_2.click()
    time.sleep(2)
    ...
    button7.click()
    time.sleep(2)
    button8 = driver.find_element_by_link_text("23")
    button8.click()
    time.sleep(2)
    ...
    button10.click()
    time.sleep(2)
    button11 = driver.find_element_by_link_text("23")
    button11.click()
    time.sleep(2)
    ...
    button13.click()
    time.sleep(2)
    button14 = driver.find_element_by_link_text("22")
    button14.click()
    time.sleep(2)
    ...
    button16.click()
    time.sleep(2)
    button17 = driver.find_element_by_link_text("23")
    button17.click()
    time.sleep(2)
